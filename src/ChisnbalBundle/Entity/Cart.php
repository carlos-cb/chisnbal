...
class Cart
{
     ...
     * Add cartItems
     *
     * @param \ChisnbalBundle\Entity\CartItem $cartItems
     * @return Cart
     */
    public function addCartItem(\ChisnbalBundle\Entity\CartItem $cartItems)
    {
     ...
     * @param \ChisnbalBundle\Entity\CartItem $cartItems
     */
    public function removeCartItem(\ChisnbalBundle\Entity\CartItem $cartItems)
    {
